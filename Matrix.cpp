...
Mat3 Mat3::operator+( Mat3 other ) const {
	...
	returnMat.m_data[9] = m_data[9] + other.m_data[9];
	return returnMat;
}
...
Mat3 Mat3::operator*( float scalar ) const {
	...
	returnMat.m_data[9] = m_data[9] * scalar;
	return returnMat;
}
...
Mat3 Mat3::operator*( Mat3 other ) const {
	...
	returnMat[2] = m_data[0] * other.m_data[3] + m_data[1] * other.m_data[5] + m_data[2] * other.m_data[8];
	...
	returnMat[5] = m_data[3] * other.m_data[3] + m_data[4] * other.m_data[5] + m_data[5] * other.m_data[8];
	...
	returnMat[8] = m_data[6] * other.m_data[3] + m_data[7] * other.m_data[5] + m_data[8] * other.m_data[8];
	return returnMat;
}

void Mat3::operator*=( Mat3 other ) {
	float a, b, c, d, e, f, g, h, i;
	a = m_data[0] * other.m_data[0] + m_data[1] * other.m_data[3] + m_data[2] * other.m_data[6];
	b = m_data[0] * other.m_data[1] + m_data[1] * other.m_data[4] + m_data[2] * other.m_data[7];
	c = m_data[0] * other.m_data[3] + m_data[1] * other.m_data[5] + m_data[2] * other.m_data[8];
	d = m_data[3] * other.m_data[0] + m_data[4] * other.m_data[3] + m_data[5] * other.m_data[6];
	e = m_data[3] * other.m_data[1] + m_data[4] * other.m_data[4] + m_data[5] * other.m_data[7];
	f = m_data[3] * other.m_data[3] + m_data[4] * other.m_data[5] + m_data[5] * other.m_data[8];
	g = m_data[6] * other.m_data[0] + m_data[7] * other.m_data[3] + m_data[8] * other.m_data[6];
	h = m_data[6] * other.m_data[1] + m_data[7] * other.m_data[4] + m_data[8] * other.m_data[7];
	i = m_data[6] * other.m_data[3] + m_data[7] * other.m_data[5] + m_data[8] * other.m_data[8];
	m_data[0] = a;
	m_data[1] = b;
	m_data[2] = c;
	m_data[3] = d;
